...
class RewardMerchantModel extends RewardMerchantEntity {
  const RewardMerchantModel({
    required super.id,
    super.image,
    super.type,
    super.name,
  ...
  factory RewardMerchantModel.fromJson(Map<String, dynamic> json) {
    return RewardMerchantModel(
      id: json['id'],
      image: json['image'] ?? '',
      type: json['type'] ?? '',
      name: json['name'] ?? '',
